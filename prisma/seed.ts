...
async function main() {
  ...
  // Create Projects (master list sorted by project name)
  console.log('📁 Creating projects...')
  const masterProjectDefs = [
    {
      name: 'AI - Backend API',
    ...
    {
      name: 'Bill-sync-data',
      description: 'Bill data synchronization and integration service',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-07-01'),
      dueDate: new Date('2025-12-31'),
    ...
    {
      name: 'Corporate (FastAPI)',
      description: 'Corporate backend API infrastructure (FastAPI)',
      status: 'In Progress',
      priority: 'High',
    ...
    {
      name: 'Corporate (VueJS)',
      description: 'Corporate web application frontend (VueJS)',
      status: 'In Progress',
      priority: 'High',
      startDate: new Date('2025-08-01'),
      dueDate: new Date('2026-01-31'),
    ...
    },
    {
      ...
      description: 'Corporate planning and strategy management system',
      status: 'In Progress',
      priority: 'High',
      startDate: new Date('2025-08-01'),
    ...
    {
      name: 'LLM AI',
      description: 'Large language model AI services and integrations',
      status: 'In Progress',
      priority: 'High',
      startDate: new Date('2025-08-01'),
      dueDate: new Date('2026-01-31'),
    ...
    {
      name: 'MarketingOps',
      description: 'Marketing operations and campaign management platform',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-01'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Membership',
      description: 'Customer membership and loyalty management system',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-07-15'),
      dueDate: new Date('2026-01-31'),
    ...
    {
      name: 'Sales Ops AEC',
      description: 'Sales operations for AEC markets',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-15'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Sales Ops ALL',
      description: 'Sales operations across all markets',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-15'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Sales Ops Cambodia (KH)',
      description: 'Sales operations for Cambodia (KH)',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-15'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Sales Ops LAOS',
      description: 'Sales operations for Laos',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-15'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Sales Ops Myanmar (MM)',
      description: 'Sales operations for Myanmar (MM)',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-15'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Sales Ops THAI',
      description: 'Sales operations for Thailand',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-08-15'),
      dueDate: new Date('2026-02-28'),
    ...
    {
      name: 'Tiktok service',
      description: 'TikTok integration and commerce service',
      status: 'In Progress',
      priority: 'Medium',
      startDate: new Date('2025-09-01'),
      dueDate: new Date('2026-03-31'),
    ...
    {
      name: 'Umbrella Campaign 2025',
      description: 'Umbrella marketing campaign for 2025',
      status: 'In Progress',
      priority: 'High',
  ...
  const projects = await Promise.all(
    masterProjectDefs.map((data) => prisma.project.create({ data }))
  )

  const projectByName = Object.fromEntries(projects.map((p) => [p.name, p])) as Record<
    string,
  ...
  await Promise.all([
    ...
    prisma.projectMember.create({
      data: { projectId: projectByName['AI - Backend API'].id, userId: users[1].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['AI - Backend API'].id, userId: users[3].id, role: 'member' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['AI - Backend API'].id, userId: users[4].id, role: 'member' },
    }),

    // AI - Frontend NextJS team
    prisma.projectMember.create({
      data: { projectId: projectByName['AI - Frontend NextJS'].id, userId: users[2].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['AI - Frontend NextJS'].id, userId: users[6].id, role: 'member' },
    }),

    // Bill-collection team
    prisma.projectMember.create({
      data: { projectId: projectByName['Bill-collection'].id, userId: users[8].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Bill-collection'].id, userId: users[5].id, role: 'member' },
    }),

    // Cipher team
    prisma.projectMember.create({
      data: { projectId: projectByName['Cipher'].id, userId: users[1].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Cipher'].id, userId: users[9].id, role: 'member' },
    }),

    // Corporate (FastAPI) team
    prisma.projectMember.create({
      data: { projectId: projectByName['Corporate (FastAPI)'].id, userId: users[1].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Corporate (FastAPI)'].id, userId: users[3].id, role: 'member' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Corporate (FastAPI)'].id, userId: users[5].id, role: 'member' },
    }),

    // Corporate (VueJS) team
    prisma.projectMember.create({
      data: { projectId: projectByName['Corporate (VueJS)'].id, userId: users[2].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Corporate (VueJS)'].id, userId: users[6].id, role: 'member' },
    }),

    // Odoo team
    prisma.projectMember.create({
      data: { projectId: projectByName['Odoo'].id, userId: users[1].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Odoo'].id, userId: users[4].id, role: 'member' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['Odoo'].id, userId: users[9].id, role: 'member' },
    }),

    // iSFA team
    prisma.projectMember.create({
      data: { projectId: projectByName['iSFA'].id, userId: users[7].id, role: 'lead' },
    }),
    prisma.projectMember.create({
      data: { projectId: projectByName['iSFA'].id, userId: users[0].id, role: 'member' },
    }),
  ])
  ...
  const milestones = await Promise.all([
    prisma.milestone.create({
      data: {
        ...
        status: 'In Progress',
        projectId: projectByName['AI - Backend API'].id,
      },
    }),
    prisma.milestone.create({
      data: {
        ...
        dueDate: new Date('2025-11-30'),
        status: 'Not Started',
        projectId: projectByName['AI - Frontend NextJS'].id,
      },
    }),
    prisma.milestone.create({
      data: {
        ...
        dueDate: new Date('2026-01-15'),
        status: 'In Progress',
        projectId: projectByName['Corporate (FastAPI)'].id,
      },
    }),
    prisma.milestone.create({
      data: {
        ...
        dueDate: new Date('2025-11-15'),
        status: 'In Progress',
        projectId: projectByName['Odoo'].id,
      },
    }),
  ])
  ...
  const tasks = await Promise.all([
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 16,
        actualHours: 12,
        projectId: projectByName['Bill-collection'].id,
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 10,
        actualHours: 11,
        projectId: projectByName['Cipher'].id,
        assigneeId: users[1].id,
        creatorId: users[1].id,
      },
    }),
  ...
  await Promise.all([
    ...
    prisma.issue.create({
      data: {
        ...
        priority: 'Medium',
        type: 'Feature',
        projectId: projectByName['Corporate (VueJS)'].id,
        reporterId: users[2].id,
        assigneeId: users[6].id,
      },
    }),
    ...
    prisma.issue.create({
      data: {
        ...
        priority: 'Low',
        type: 'Feature',
        projectId: projectByName['iSFA'].id,
  ...
  const additionalTasks = await Promise.all([
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 160,
        actualHours: 0,
        projectId: projectByName['Corporate (VueJS)'].id, // Corporate (VueJS)
        assigneeId: users[0].id,
        creatorId: users[0].id,
      },
    }),
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 120,
        actualHours: 0,
        projectId: projectByName['Sales Ops ALL'].id, // Sales Ops ALL
        assigneeId: users[0].id,
        creatorId: users[0].id,
      },
    }),
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 80,
        actualHours: 0,
        projectId: projectByName['Cipher'].id, // Cipher
        assigneeId: users[0].id,
        creatorId: users[0].id,
      },
    }),
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 100,
        actualHours: 0,
        projectId: projectByName['Xpress-Redeem'].id, // Xpress-Redeem
        assigneeId: users[0].id,
        creatorId: users[0].id,
      },
    }),
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 100,
        actualHours: 0,
        projectId: projectByName['Bill-collection'].id, // Bill-collection
        assigneeId: users[0].id,
        creatorId: users[0].id,
      },
    }),
    ...
    prisma.task.create({
      data: {
        ...
        estimatedHours: 120,
        actualHours: 0,
        projectId: projectByName['IMS'].id, // IMS
        assigneeId: users[0].id,
        creatorId: users[0].id,
      },
    }),
  ...
  const projectTaskMap: Record<string, string> = {
    'Corporate (VueJS)': additionalTasks[0].id,
    'Sales Ops ALL': additionalTasks[1].id,
  ...
  await Promise.all([
    prisma.timeEntry.create({
      data: {
        ...
        userId: users[0].id,
        taskId: projectTaskMap['Corporate (VueJS)'],
      },
    }),
    prisma.timeEntry.create({
      data: {
    ...
    prisma.timeEntry.create({
      data: {
        ...
        date: parseDate('1/10/2025'),
        userId: users[0].id,
        taskId: projectTaskMap['Sales Ops ALL'],
      },
    }),
    prisma.timeEntry.create({
      data: {
  ...
  await Promise.all([
    prisma.activityLog.create({
      data: {
        action: 'created',
        entity: 'project',
        entityId: projectByName['AI - Backend API'].id,
